...
@section('container')
	...
	<p><strong><small>{{ trans('installer_messages.final.success') }}</small></strong></p>
	<pre>
		<code>
			{{ trans('installer_messages.final.email') }}: {{ trans('superadmin@acculance.com') }}
			{{ trans('installer_messages.final.password') }}: {{ trans('acculance2022') }}
		</code>
	</pre>
