        ...
        <div class="card">
          ...
          >
            <div class="card-body">
              ...
              <div v-if="form.client" class="row">
                <div class="form-group col-md-4">
                  ...
                  <input
                    ...
                    v-model="form.client.clientInvoiceTotal"
                    type="text"
                    class="form-control"
                ...
                <div class="form-group col-md-4">
                  ...
                  <input
                    id="clientTotalPaid"
                    v-model="form.client.clientTotalPaid"
                    type="text"
                    class="form-control"
              ...
              <div
                v-if="form.errors.errors && form.errors.errors.selectedInvoices"
                class="col-md-11 m-auto"
              >
                <div
                  v-for="(msg, i) in form.errors.errors.selectedInvoices"
                  :key="i"
              ...
              <div v-if="form.selectedInvoices" class="col-md-11 m-auto">
                <div
                  v-for="(item, i) in form.selectedInvoices"
                  :key="i"
