    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          ...
          <form
            role="form"
            @submit.prevent="updateAuthority"
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  <label for="ccLoanLimit"
                    >{{ $t('loans.common.cash_credit_limit') }}
                    <span class="required">*</span></label
                  >
                  <input
                    id="ccLoanLimit"
                    v-model="form.ccLoanLimit"
                    type="number"
                    step=".01"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('ccLoanLimit') }"
                    name="ccLoanLimit"
                    :placeholder="$t('loans.common.cc_placeholder')"
                    :min="form.ccLoanTaken"
                  />
