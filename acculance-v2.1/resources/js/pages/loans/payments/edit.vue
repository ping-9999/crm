    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          ...
          <form
            role="form"
            @submit.prevent="updateLoanPayment"
              ...
              <div v-if="items" class="row">
                <div class="form-group col-md-6">
                  ...
                  <v-select
                    ...
                    :options="items"
                    label="reference"
                    :class="{ 'is-invalid': form.errors.has('loan') }"
                    name="loan"
                    :placeholder="$t('loans.common.loan_placeholder')"
                    disabled
                  />
              ...
              <div class="row" v-if="accounts">
                <div class="form-group col-md-6">
                  ...
                  <v-select
                    ...
                    @input="calculateAvailableBalnce"
                  />
