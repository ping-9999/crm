          ...
          >
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="form-group col-md-4">
                  ...
                  <input
                    ...
                    type="text"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('referenceNo') }"
                    name="referenceNo"
                ...
                <div class="form-group col-md-4">
                  ...
                  <select
                    ...
                    name="loanType"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('loanType') }"
                    disabled
                  >
                    <option value="1">
              ...
              <div class="row" v-if="form.authority && form.loanType == 0">
                <div class="form-group col-md-6">
                  <label for="ccLoanLimit"
                    >{{ $t('loans.common.cc_limit') }}
                    <span class="required">*</span></label
                  >
                  <input
                    id="ccLoanLimit"
                    v-model="form.authority.ccLimit"
                    type="text"
                    class="form-control"
                    name="ccLoanLimit"
                    readonly
                ...
                <div class="form-group col-md-6">
                  ...
                  <input
                    id="availableAmount"
                    v-model="form.authority.availableCCLoan"
                    type="text"
                    class="form-control"
              ...
              <div v-else class="row">
                <div class="form-group col-md-6">
                  ...
                  <input
                    ...
                    name="amount"
                    :placeholder="$t('common.amount_placeholder')"
                    :min="form.due - form.interestAmount"
                    :max="
                ...
                <div class="form-group col-md-6">
                  ...
                  <input
                    ...
                    step="any"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('interest') }"
                    min="0"
                    max="100"
                    name="interest"
                    :placeholder="$t('loans.common.interest_rate_placeholder')"
                    @change="generatePayable"
                    @keyup="generatePayable"
                  />
                </div>
                <div class="form-group col-md-4">
                  ...
                  <select
                    ...
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('paymentType') }"
                    @change="generatePayable"
                  >
                ...
                <div class="form-group col-md-4">
                  ...
                  <input
                    ...
                    name="duration"
                    :placeholder="$t('loans.common.duration_placeholder')"
                    min="1"
                    max="255"
                    @change="generatePayable"
                    @keyup="generatePayable"
                ...
                <div class="form-group col-md-4">
                  ...
                  <input
                    id="payReturn"
                    v-model="form.payReturn"
                    type="text"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('payReturn') }"
                    name="payReturn"
                    readonly
                  />
                ...
                <div class="form-group col-md-6">
                  ...
                  <input
                    id="payableAmount"
                    v-model.lazy="form.payableAmount"
                    type="text"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('payableAmount') }"
                    name="payableAmount"
                    readonly
                  />
                </div>
