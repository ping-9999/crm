            ...
            <div class="card-body">
              <div class="row">
                <div v-if="items" class="form-group col-md-6">
                  ...
                  <v-select
                    ...
                    :options="items"
                    label="name"
                    :class="{ 'is-invalid': form.errors.has('employee') }"
                    name="employee"
                    :placeholder="$t('common.employee_placeholder')"
                    @input="calculateTotalSalary"
                  />
                  <has-error :form="form" field="employee" />
                </div>
                <div class="form-group col-md-6">
                  <label for="salaryMonth"
                    >{{ $t('payroll.common.salary_month')
                    }}<span class="required">*</span></label
                  >
                  <select
                    id="salaryMonth"
                    ...
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('salaryMonth') }"
                    name="salaryMonth"
                  >
              ...
              <div v-if="form.employee" class="row">
                <div class="form-group col-md-4">
                  ...
                  <input
                    id="presentSalary"
                    v-model="form.employee.totalSalary"
                    type="number"
                    step="any"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('presentSalary') }"
                    name="presentSalary"
                    readonly
                  />
                </div>
                <div class="form-group col-md-4">
                  ...
                  <input
                    ...
                    min="0"
                    :placeholder="
                      $t('payroll.common.deduction_amount_placeholder')
                    "
                    @change="calculateTotalSalary"
                ...
                <div class="form-group col-md-4">
                  ...
                  <input
                    ...
                    :placeholder="
                      $t('payroll.common.deduction_reason_placeholder')
                    "
                  />
              ...
              <div class="row">
                <div class="form-group col-md-3">
                  ...
                  <input
                    id="mobileBill"
                    v-model="form.mobileBill"
                    type="number"
                    step="any"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('mobileBill') }"
                    name="mobileBill"
                    min="0"
                    :placeholder="$t('payroll.common.mobile_bill_placeholder')"
                    @change="calculateTotalSalary"
                    @keyup="calculateTotalSalary"
                  />
                ...
                <div class="form-group col-md-3">
                  ...
                  <input
                    id="foodBill"
                    v-model="form.foodBill"
                    type="number"
                    step="any"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('foodBill') }"
                    name="foodBill"
                    :placeholder="$t('payroll.common.food_bill_placeholder')"
                    @change="calculateTotalSalary"
                    @keyup="calculateTotalSalary"
                  />
                ...
                <div class="form-group col-md-3">
                  ...
                  <input
                    ...
                    name="bonus"
                    min="0"
                    :placeholder="$t('payroll.common.bonus_placeholder')"
                    @change="calculateTotalSalary"
                    @keyup="calculateTotalSalary"
                  />
              ...
              <div class="row">
                <div class="form-group col-md-3">
                  ...
                  <input
                    id="festivalBonus"
                    v-model="form.festivalBonus"
                    type="number"
                    step="any"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('festivalBonus') }"
                    name="festivalBonus"
                    min="0"
                    :placeholder="
                ...
                <div class="form-group col-md-3">
                  ...
                  <input
                    ...
                    :placeholder="
                      $t('payroll.common.travel_allowance_placeholder')
                    "
                    @change="calculateTotalSalary"
                    @keyup="calculateTotalSalary"
                  />
                ...
                <div class="form-group col-md-3">
                  ...
                  <input
                    ...
                    step="any"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('others') }"
                    name="others"
                    min="0"
                    :placeholder="$t('payroll.common.others_placeholder')"
                    @change="calculateTotalSalary"
                    @keyup="calculateTotalSalary"
                  />
                ...
                <div class="form-group col-md-3">
                  ...
                  <input
                    ...
                    step="any"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('advance') }"
                    name="advance"
                    :placeholder="$t('payroll.common.advance')"
                    @change="calculateTotalSalary"
                    @keyup="calculateTotalSalary"
                  />
              ...
              <div class="row">
                <div class="form-group col-md-4">
                  ...
                  <input
                    ...
                    step="any"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('totalSalary') }"
                    name="totalSalary"
                    readonly
                  />
              ...
              <div class="row">
                ...
                <div class="form-group col-md-4">
                  ...
                  <input
                    ...
                    type="date"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('salaryDate') }"
                    name="salaryDate"
                  />
