    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          ...
          <form
            role="form"
            @submit.prevent="updateIncrement"
              ...
              <div class="row" v-if="form.employee">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input
                    ...
                    :placeholder="
                      $t('employees.common.increment_amount_placeholder')
                    "
                    min="0"
                    :max="form.employee.totalSalary"
                  />
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <input
                    ...
                    type="date"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('incrementDate') }"
                    name="incrementDate"
                  />
