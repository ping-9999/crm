              ...
              <div class="row" v-if="items && products">
                ...
                <div class="form-group col-md-12 col-xl-3">
                  ...
                  <input
                    ...
                    type="text"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('purchaseNo') }"
                    name="purchaseNo"
                    :placeholder="
              ...
              >
                <div class="table-responsive table-custom w-95 m-auto">
                  <table class="table table-hover table-sm text-center">
                    ...
                    <tbody>
                      <tr
                        v-for="(item, i) in form.selectedProducts"
                        :key="i"
                        class="text-center"
                      >
                        <td>{{ ++i }}</td>
                      ...
                      <tr v-if="form.subTotal">
                        <td
                          :colspan="form.purchaseReturnData ? 7 : 6"
                          class="text-right"
                        >
