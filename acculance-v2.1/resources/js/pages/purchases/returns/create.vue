    ...
    <div class="row">
      <div class="col-lg-12 col-xl-12">
        <div class="card">
          ...
          <form
            role="form"
            @submit.prevent="savePurchaseReturn"
            ...
            <div class="card-body">
              ...
              <div class="row" v-if="form.supplier && supplierPurchases">
                <div class="form-group col-md-12">
                  ...
                  <v-select
                    ...
                    :options="supplierPurchases"
                    label="purchaseNo"
                    :class="{ 'is-invalid': form.errors.has('purchase') }"
                    name="purchase"
                    :placeholder="$t('common.purchases_placeholder')"
                    @input="storeProducts"
                  />
              ...
              <div v-if="form.purchase" class="row">
                <div class="form-group col-md-4">
                  ...
                  <input
                    id="discount"
                    v-model="form.purchase.totalDiscount"
                    type="number"
                    step="any"
                    class="form-control"
                    name="discount"
                ...
                <div class="form-group col-md-4">
                  ...
                  <input
                    id="transportCost"
                    v-model="form.purchase.transport"
                    type="number"
                    step="any"
                    class="form-control"
                    name="transportCost"
                ...
                <div class="form-group col-md-4">
                  ...
                  <input
                    id="totalPaid"
                    v-model="form.purchase.totalPaid"
                    type="number"
                    step="any"
                    class="form-control"
                    name="totalPaid"
