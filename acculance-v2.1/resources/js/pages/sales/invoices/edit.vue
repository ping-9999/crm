                  ...
                  <table class="table table-hover table-sm text-center">
                    ...
                    <tbody>
                      ...
                      <tr v-if="form.subTotal">
                        <td
                          :colspan="form.totalInvoiceReturn > 0 ? 7 : 6"
                          class="text-right"
                        >
              ...
              <div class="row">
                ...
                >
                  ...
                  <v-select
                    ...
                    name="orderTax"
                    :placeholder="$t('common.invoice_tax_placeholder')"
                    @input="calculateSum"
                  />
                ...
                >
                  ...
                  <input
                    ...
                    v-model="form.totalInvoiceReturn"
                    type="number"
                    step="any"
                    class="form-control"
