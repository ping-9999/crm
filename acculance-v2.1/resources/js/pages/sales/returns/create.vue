    ...
    <div class="row">
      <div class="col-lg-12 col-xl-12">
        <div class="card">
          ...
          <form
            role="form"
            @submit.prevent="saveInvoiceReturn"
          ...
          >
            <div class="card-body">
              <div class="row" v-if="items">
                <div class="form-group col-md-6">
                  ...
                  <input
                    ...
                    type="text"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('returnReason') }"
                    name="returnReason"
              ...
              <div class="row" v-if="form.client && clientInvoices">
                <div class="form-group col-md-12">
                  ...
                  <v-select
                    ...
                    name="invoice"
                    :placeholder="$t('common.invoices_placeholder')"
                    @input="storeProducts"
                  />
              ...
              >
                ...
                >
                  <div
                    v-for="(msg, i) in form.errors.errors.selectedProducts"
                    :key="i"
                        ...
                        <td>
                          <div class="input-group custom-qty-input">
                            <input
                              ...
                              data-field="quantity"
                              @click="updateItem(item.returnQty - 1, i - 1)"
                            />
                            <input
                              type="number"
                              step="any"
                              ...
                              @keyup="updateItem($event.target.value, i - 1)"
              ...
              <div v-if="form.invoice" class="row">
                <div
                  v-if="form.discountPercentage > 0"
                ...
                <div
                  class="form-group"
                  :class="form.discountPercentage > 0 ? 'col-md-2' : 'col-md-4'"
                >
              ...
              <div class="row">
                ...
                <div class="form-group col-md-4">
                  ...
                  <input
                    id="totalPaid"
                    v-model="form.invoice.totalPaid"
                    type="number"
                    step="any"
                    class="form-control"
                    name="totalPaid"
                ...
                <div v-else class="form-group col-md-4">
                  ...
                  <input
                    id="newDueText"
                    v-model="form.newDueText"
                    type="text"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('newDueText') }"
                    name="newDueText"
                    readonly
                  />
