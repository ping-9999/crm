        ...
        if (DB::connection()->getDatabaseName()) {
            if (Schema::hasTable('general_settings') && Schema::hasTable('currencies')) {
                ...
                if (count($allSettings) > 0) {
                    ...
                    config([
                        'config.proSubCatPrefix' => $allSettings->where('key', 'product_sub_cat_prefix')->first()->value,
                    ]);
                    ...
                    config([
                        'config.purchaseReturnPrefix' => $allSettings->where('key', 'pur_return_prefix')->first()->value,
                    ]);
                    config([
